...
image = io.imread("./Math-Foundation-for-Computing/lecture/hearts.jpeg")
...
for i, contour in enumerate(contours):
    ...
    coeffs_x = np.genfromtxt('./Math-Foundation-for-Computing/lecture/vday_plot_8_x_coeffs.csv', delimiter=',')
    coeffs_y = np.genfromtxt('./Math-Foundation-for-Computing/lecture/vday_plot_8_y_coeffs.csv', delimiter=',')
